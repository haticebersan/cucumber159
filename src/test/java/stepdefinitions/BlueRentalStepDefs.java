...
public class BlueRentalStepDefs {
    ...
    public void user_enters_the_admin_email_and_password(DataTable dataTable) {
        ...
        List<String> credentials = dataTable.row(1);//We can get the data in different form such as List<String>, List<List<String>>, List<Map<>> ...
    ...
    public void verify_the_login_is_successful() {
        ...
        //assertTrue(false);//will fail on purpose
